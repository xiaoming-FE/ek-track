...
const browsersList = [
  ...
  /* Chrome-based Extended Browser => [QQ, sogou, baidu, UC, aoyou] */
  {
    test: [/QQ|QQBrowser/i],
    describe(ua) {
      const browser = {
      ...
      const version = getFirstMatch(/(?:qq|qqbrowser)\/([\d.]+)/i, ua);
      if (version) {
        browser.version = version;
      }
      return browser;
  ...
  {
    test: [/SE[\s+]2\.x[\s+]metasr/i],
    describe(ua) {
      const browser = {
        name: 'sougou',
      };
      const version = getFirstMatch(/SE[\s+]2\.x[\s+]metasr[\s+]([\d.]+)/i, ua);
      if (version) {
        browser.version = version;
      }
      return browser;
  ...
  },
  {
    ...
    describe(ua) {
      ...
      const version = getFirstMatch(/bidubrowser(?:[\s+|\/])([\d.]+)/i, ua);
      if (version) {
        browser.version = version;
      }
      return browser;
  ...
  },
  {
    ...
    describe(ua) {
      ...
      const version = getFirstMatch(/ubrowser\/([\d.]+)/i, ua);
      if (version) {
        browser.version = version;
      }
      return browser;
  ...
  },
  {
    ...
    describe(ua) {
      ...
      const version = getFirstMatch(/maxthon\/([\d.]+)/i, ua);
      if (version) {
        browser.version = version;
      }
      return browser;
